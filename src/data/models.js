...
export const BUCKET_TEMPLATES = {
  ...
  wants: [
    ...
    { name: 'Vacations', emoji: '✈️' },
    { name: 'Movies', emoji: '🎬' },
    { name: 'Gaming', emoji: '🎮' },
    { name: 'Streaming', emoji: '📺' },
    { name: 'Shopping', emoji: '🛍️' },
    { name: 'Luxury Items', emoji: '💎' },
    { name: 'Gadgets', emoji: '📷' },
    { name: 'Hobbies', emoji: '🎨' },
    { name: 'Coffee', emoji: '☕' },
    { name: 'Gym', emoji: '🏋️' },
  ...
  future: [
    ...
    { name: 'PPF', emoji: '🏛️' },
    { name: 'NPS', emoji: '🧓' },
    { name: 'Fixed Deposits', emoji: '🏦' },
    { name: 'Business', emoji: '💼' },
    { name: 'Extra Loan Repayment', emoji: '💸' },
    { name: 'Cash Reserves', emoji: '💰' },
    { name: 'Long-term Savings', emoji: '🌱' },
  ],
};
