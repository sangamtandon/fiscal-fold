    ...
    <div class="flex flex-col gap-6">
      ...
      ${quickBuckets.length > 0 ? `
        <div>
          ...
          <div class="quick-buckets" role="group" aria-label="Quick Buckets">
            ${quickBuckets.map(b => `
              <button type="button" class="quick-bucket" data-bucket-id="${escapeHtml(b.id)}" aria-label="${escapeHtml(b.name)}, ${formatCurrency(Math.max(0, b.allocated - b.spent))} available">
