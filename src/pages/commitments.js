  ...
  drawer.innerHTML = `
    ...
    <div class="cm-form">
      <div class="cm-form__header">
        ...
        <button class="btn btn-ghost" data-close-mp title="Close" aria-label="Close">✕</button>
      </div>
  ...
  _formDrawer.innerHTML = `
    ...
    <div class="cm-form">
      <div class="cm-form__header">
        ...
        <button class="btn btn-ghost" id="cf-close" title="Close" aria-label="Close">✕</button>
      </div>
