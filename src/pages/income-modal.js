...
function _renderAmount() {
  _drawer.innerHTML = `
    <div class="income-drawer__header">
      ...
      <button class="btn-icon income-drawer__close" id="ic-close" aria-label="Close" title="Close">✕</button>
    </div>
...
function _renderBucket() {
  ...
  _drawer.innerHTML = `
    <div class="income-drawer__header">
      <button class="btn-icon" id="ic-back" aria-label="Back" title="Back">←</button>
