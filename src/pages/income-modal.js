...
function _renderAmount() {
  _drawer.innerHTML = `
    <div class="income-drawer__header">
      ...
      <button class="btn-icon income-drawer__close" id="ic-close" title="Close" aria-label="Close">✕</button>
    </div>
...
function _renderBucket() {
  ...
  _drawer.innerHTML = `
    <div class="income-drawer__header">
      <button class="btn-icon" id="ic-back" title="Back" aria-label="Back">←</button>
